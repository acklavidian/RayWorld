...
// Vertex shader: cube is centered on camera.  Vertex positions double as view
// directions.  We negate the position to flip face winding (we're inside the
// cube), and use .xyww to force depth = 1.0 (far plane).
const SKY_VS = `#version 330
